package com.hades.example.java.security.hash.sha;
...
public class Test {
    ...
    private void test() {
        SHATool tool = new SHATool();
        byte[] hashedBytes = tool.hash(Constants.toEncryptContent2);
        ...
        String hashedString = tool.hashToHex(Constants.toEncryptContent2);
        // 296c787ce7e8524ca2df818da7b7feb338b799443e95655f6022a7317b89ad8d
