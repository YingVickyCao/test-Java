package com.example.hades.java.code.io.java_read_unsigned_8_bytes;
 ...
 */
public class TestJavaUnsigned8Bytes {
    private static final String TAG = TestJavaUnsigned8Bytes.class.getSimpleName();
